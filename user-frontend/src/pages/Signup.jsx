  ...
  return (
    <div className="auth-wrapper" style={{ backgroundImage: `url(${loginImg})` }}>
      <div className="auth-container signup-layout">
        <div className="auth-right"> {/* Flipped: Form is on the left in the container, but I'll use CSS to order it */}
        ...
        <div className="auth-left">
          <p className="signup-prompt-text">Already have an account ?</p>
